...
function file_video(path){
	...
	var playBtn = `<a class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-theme-accent" href="iina://weblink?url=${url}"><i class="mdui-icon material-icons">play_circle_filled;</i>Play in IINA</a><a class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-theme-accent" href="https://iina.io/"><i class="mdui-icon material-icons">get_app</i>Download IINA Player</a>`;
	if (/(iPhone|iPad|iPod|iOS|Android)/i.test(navigator.userAgent)) {
	    playBtn = `	<a class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-theme-accent" href="nplayer-${url}"><i class="mdui-icon material-icons">&#xe039;</i>Play in nPlayer</a><a class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-theme-accent" href="https://apps.apple.com/us/app/nplayer-lite/id1078835991"><i class="mdui-icon material-icons">get_app</i>Download nPlayer</a>`;
	}
	var content = `
